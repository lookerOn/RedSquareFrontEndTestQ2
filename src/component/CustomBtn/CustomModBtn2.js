...
const CustomModBtn2 = ({ onPress, text, type }) => {

    const styles = StyleSheet.create({
        btn: {
            backgroundColor: 'rgba(247, 250, 248, 1)',
            width: Dimensions.get('window').width * 0.65, // Adjust the logo size as needed
            alignItems: 'center',
            marginTop: 10,
            borderColor: 'rgba(247, 250, 248, 0.5)',
            borderRadius: 8,
            borderWidth: 1,
        },
        ...
        btn_TERTIARY: {
            backgroundColor: 'rgba(247, 250, 248, 0)',
            borderColor: 'rgba(247, 250, 248, 0)',
            borderRadius: 8,
            borderWidth: 1,
        },
