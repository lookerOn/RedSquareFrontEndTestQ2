import { View, Text, StyleSheet, Image, Dimensions, FlatList, TextInput, TouchableOpacity, ScrollView, Modal } from 'react-native';
...
const CategorySearchScreen = () => {
    ...
    const CTsearchQuery = route.params?.ctgysearchQuery; // Use the correct parameter name here

    
    if (CTsearchQuery){
        console.log(CTsearchQuery); //check value pass success or  not
    }else{
    ...
    const CTSEARCH = async (CTsearchQuery) => {
        // setSelectedCategory(CTsearchQuery);
    ...
    useEffect(() => {
        ...
        const apiUrl = isSearching ? `https://dummyjson.com/products/search?q=${searchQuery}` : `https://dummyjson.com/products/category/${CTsearchQuery}`;
        fetch(apiUrl)
            .then((res) => res.json())
            .then((data) => {
    ...
    }, [searchQuery, CTsearchQuery, isSearching]);
        ...
        <View style={{ backgroundColor: 'white', height: '100%', }}>
            <View style={{
                ...
                <View style={{
                    ...
                    >
                        <CustomBtnCategory onPress={() => CTSEARCH("smartphones")} text="Smartphones" type="SECOND" selected={CTsearchQuery === "smartphones"} />
                        <CustomBtnCategory onPress={() => CTSEARCH("laptops")} text="Laptops" type="PRIMARY" selected={CTsearchQuery === "laptops"} />
                        <CustomBtnCategory onPress={() => CTSEARCH("fragrances")} text="Fragrances" type="SECOND" selected={CTsearchQuery === "fragrances"} />
                        <CustomBtnCategory onPress={() => CTSEARCH("skincare")} text="Skincare" type="PRIMARY" selected={CTsearchQuery === "skincare"} />
                        <CustomBtnCategory onPress={() => CTSEARCH("groceries")} text="Groceries" type="SECOND" selected={CTsearchQuery === "groceries"} />
                        <CustomBtnCategory onPress={() => CTSEARCH("home-decoration")} text="Home-decoration" type="TERTIARY" selected={CTsearchQuery === "home-decoration"} />
                        <CustomBtnCategory onPress={() => CTSEARCH("furniture")} text="Furniture" type="PRIMARY" selected={CTsearchQuery === "furniture"} />
                        <CustomBtnCategory onPress={() => CTSEARCH("tops")} text="Tops" type="PRIMARY" selected={CTsearchQuery === "tops"} />
                        <CustomBtnCategory onPress={() => CTSEARCH("womens-dresses")} text="Womens-dresses" type="TERTIARY" selected={CTsearchQuery === "womens-dresses"} />
                        <CustomBtnCategory onPress={() => CTSEARCH("womens-shoes")} text="Womens-shoes" type="TERTIARY" selected={CTsearchQuery === "womens-shoes"} />
                        <CustomBtnCategory onPress={() => CTSEARCH("mens-shirts")} text="Mens-shirts" type="SECOND" selected={CTsearchQuery === "mens-shirts"} />
                        <CustomBtnCategory onPress={() => CTSEARCH("mens-shoes")} text="Mens-shoes" type="SECOND" selected={CTsearchQuery === "mens-shoes"} />
                        <CustomBtnCategory onPress={() => CTSEARCH("mens-watches")} text="Mens-watches" type="SECOND" selected={CTsearchQuery === "mens-watches"} />
                        <CustomBtnCategory onPress={() => CTSEARCH("womens-watches")} text="Womens-watches" type="TERTIARY" selected={CTsearchQuery === "womens-watches"} />
                        <CustomBtnCategory onPress={() => CTSEARCH("womens-bags")} text="Womens-bags" type="SECOND" selected={CTsearchQuery === "womens-bags"} />
                        <CustomBtnCategory onPress={() => CTSEARCH("womens-jewellery")} text="Womens-jewellery" type="TERTIARY" selected={CTsearchQuery === "womens-jewellery"} />
                        <CustomBtnCategory onPress={() => CTSEARCH("sunglasses")} text="Sunglasses" type="SECOND" selected={CTsearchQuery === "sunglasses"} />
                        <CustomBtnCategory onPress={() => CTSEARCH("automotive")} text="Automotive" type="SECOND" selected={CTsearchQuery === "automotive"} />
                        <CustomBtnCategory onPress={() => CTSEARCH("motorcycle")} text="Motorcycle" type="SECOND" selected={CTsearchQuery === "motorcycle"} />
                        <CustomBtnCategory onPress={() => CTSEARCH("lighting")} text="Lighting" type="PRIMARY" selected={CTsearchQuery === "lighting"} />
